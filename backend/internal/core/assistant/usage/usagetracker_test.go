...
func TestTracker_AddLLMCall(t *testing.T) {
	tracker := &Tracker{}
...
func TestTracker_AddToolCall(t *testing.T) {
	tracker := &Tracker{}
...
func TestFromContext_WithTracker(t *testing.T) {
...
func TestTracker_CumulativeMetrics(t *testing.T) {
	tracker := &Tracker{}

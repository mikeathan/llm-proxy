...
in [`.agents/rules/`](../../.agents/rules/) and [`engineering-practices.md`](engineering-practices.md).

**When to load:** writing or reviewing any code — new features, refactors, bug
fixes, PR review. Pair with [`tdd-guide.md`](tdd-guide.md) for the test cycle and
[`engineering-practices.md`](engineering-practices.md) for repo/Go/Vue specifics.
...
- **TDD/Red-Green-Refactor**: failing test → minimal pass → clean up. Test first
  forces testable design. (Repo flow: [`tdd-guide.md`](tdd-guide.md).)
...
- **Language rules are mandatory and take precedence on mechanics:**
  [`.agents/rules/go-staff-engineer.md`](../../.agents/rules/go-staff-engineer.md)
  (backend), [`.agents/rules/frontend-vue-engineer.md`](../../.agents/rules/frontend-vue-engineer.md)
  (frontend).
- **Repo-specific patterns & limits** (complexity ≤12, function length, comments,
  constants, strategy maps): [`engineering-practices.md`](engineering-practices.md).
- **Test flow & speed**: [`tdd-guide.md`](tdd-guide.md).
- **Post-change doc updates**: [`documentation-stewardship.md`](documentation-stewardship.md).

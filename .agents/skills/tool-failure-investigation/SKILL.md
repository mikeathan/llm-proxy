---
name: tool-failure-investigation
description: "Tool failure investigation: error tracing, handler scoping, and recovery-prompt verification. Use when diagnosing a failing tool call."
when_to_use: "A tool call keeps failing, loops, or the model gets a misleading recovery prompt."
status: reference

...
Full command reference: [CONTRIBUTING.md → Quick Start](CONTRIBUTING.md#quick-start). Go 1.26.2 · no Makefile/lint · gitleaks pre-commit hook (enable once with `./scripts/setup-gitleaks.sh`, see [CONTRIBUTING.md → Git Hooks](CONTRIBUTING.md#git-hooks-secret-scanning)).

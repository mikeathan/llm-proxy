...
const DEFAULT_CONFIG: GlobalConfig = {
  ...
  provider_defaults: {
    local: { max_steps: 25, context_budget: 8000, max_tokens: 2048, reasoning_budget: 0, tool_call_format: '', prefill: false },
    gemini: { max_steps: 35, context_budget: 50000, max_tokens: 4096, reasoning_budget: 0, tool_call_format: 'native', prefill: false },
    vertex: { max_steps: 35, context_budget: 50000, max_tokens: 4096, reasoning_budget: 0, tool_call_format: 'native', prefill: false },
    openai: { max_steps: 35, context_budget: 50000, max_tokens: 4096, reasoning_budget: 0, tool_call_format: 'native', prefill: false },
    openrouter: { max_steps: 30, context_budget: 30000, max_tokens: 2048, reasoning_budget: 0, tool_call_format: 'native', prefill: false },
